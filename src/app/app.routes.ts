...
export const routes: Routes = [
  ...
  { path: 'role/editor/:id', component: RoleCreateComponent },
  ...
  { path: 'CBEs/editor/:id', component: CBEsCreateComponent },
  ...
  {
    path: 'CBEs/history/maturity/:id',
    component: CBEsMaturityHistoryComponent,
  },
  {
    path: 'CBEs/history/supervisor/:id',
    component: CBEsSupervisorHistoryComponent,
  },
  ...
  {
    path: 'CBEsTargetResult/history/list',
    component: CBEsTargetResultHistoryListComponent,
  },
  {
    path: 'CBEsTargetResult/targethistory/:id',
    component: CBEsTargetHistoryByID,
  },
  {
    path: 'CBEsTargetResult/resulthistory/:id',
    component: CBEsTargetHistoryByID,
  },
  ...
  {
    path: 'CBEsPlanning/history/list',
    component: CBEsPlanningHistoryListComponent,
  },
  {
    path: 'CBEsPlanning/history/target/:id',
    component: CBEsPlanningTargetHistory,
  },
  {
    path: 'CBEsPlanning/history/result/:id',
    component: CBEsPlanningResultHistory,
  },
